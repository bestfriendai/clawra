...
function toPersonality(value: string | undefined): Personality | undefined {
  return toAllowedOption(value, PERSONALITIES) ?? toAllowedByToken(value, PERSONALITIES);
}

function toRace(value: string | undefined): Race | undefined {
  return toAllowedOption(value, RACES) ?? toAllowedByToken(value, RACES);
}

function toBodyType(value: string | undefined): BodyType | undefined {
  return toAllowedOption(value, BODY_TYPES) ?? toAllowedByToken(value, BODY_TYPES);
}
